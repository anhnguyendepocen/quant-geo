...
Problem Set #1 is a review of last week's material. Download the file `PS1.Rmd` file from Canvas (or GitHub).
...
>>>>>>> 641ce5977712cff8e9f3227cd640755da2d8f87a
...
When you restart R you will need to reload the package, but you will not need to re-install it.
