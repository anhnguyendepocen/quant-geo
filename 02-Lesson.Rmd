...
Objects are saved for later use. Use the assignment statement to save an object. You put a name on the left-hand side of the equals sign and the value on the right. Assignments do not produce output.
```{r}
x = 2 
x + 3    
x <- 10
...
Here you assigned `x` to be a numeric object. Assignments are made using the equal sign or the left-pointing arrow (less than followed by a dash).
