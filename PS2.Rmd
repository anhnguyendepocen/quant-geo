...
**2** Import the monthly precipitation dataset from my website (http://myweb.fsu.edu/jelsner/temp/data/FLMonthlyP.txt) into R.

a. What are the wettest and driest values during the month of January? (2)

b. Sort the February rainfall values from *wettest* to *driest*. (2)

c. Compute the variance of the June rainfall values. (2)

d. What is the 95th percentile value of July rainfall? (2)

e. Create a graph of August rainfall with year along the horizontal axis. (4)
...
**4** With the tornado data set (http://myweb.fsu.edu/jelsner/temp/data/Tornadoes.txt) do the following:
