...
The result is a simple feature collection with 62520 features (observations) and 21 fields (variables). Each observation is a unique tornado. Let's first glimpse the data frame. Here we use the `glimpse()` function from the **dplyr** package.
```{r}
glimpse(sfdf)
```
