...
11   | Tuesday  | November 6   | Spatial Data, Simple Features https://cran.r-project.org/web/packages/sf/vignettes/sf5.html
...
A scientific paper is advertisement for a claim. But the `proof` is the procedure that was used to obtain the result. The code should be the exact procedure.
